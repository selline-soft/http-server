...
use Selline\HttpServer\Response\StreamEmitter;
...
class StreamEmitterTest extends AbstractEmitterTest
{
    use ProphecyTrait;
    ...
    */
    ...
    {
        $contents = Stream::create('Hello world!');
