<?php
namespace Selline\HttpServer\Tests\Request;
use PHPUnit\Framework\TestCase;
use Psr\Http\Message\StreamFactoryInterface;
use Psr\Http\Message\UploadedFileInterface;
use Selline\Http\Factory;
use Selline\Http\UploadedFile;
use Selline\Http\Uri;
use Selline\HttpServer\Request\Builder;
use Nyholm\NSA;
...
class RequestBuilderTest extends TestCase
{
    ...
    public function testMarshalsExpectedHeadersFromServerArray()
    {
        ...
        $this->assertSame($expected, Builder::getHeadersFromServer($server));
    }
    ...
    public function testMarshalsVariablesPrefixedByApacheFromServerArray()
    {
        ...
        $this->assertEquals($expected, Builder::getHeadersFromServer($server));
    }
